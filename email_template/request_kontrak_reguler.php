		...
		<tr>
			<td bgcolor='#FFFFFF' style='border-bottom: 1px solid #ededed;'>
				<table width='600' border='0' cellspacing='0' cellpadding='0' align='center' class='alignCenter' style='font-family: 'ProximaNW01-AltLightReg', Helvetica, Arial, sans-serif;'>
					<tr>
						<td height='40' style='line-height: 0px; font-size: 1px;'>
							&nbsp;
						</td>
					</tr>
					<tr>
						<td align='center' class='paddingBoth' style='font-size: 30px;'>
							<p style='color: #6b6b6b;padding: 0px 0px 0px 0px;' data-color='Headline Big' data-min='16'>
								Permintaan Alokasi Kayu Kontrak Reguler
							</p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<table class='container' align='center' width='900' border='0' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; border: 0px; '>
								<tr>
									<th width='600' align='right' class='container_wrap' style='padding-left:0px;vertical-align: top;'>
										<table style=' width:615px;height:100%;padding:10px;'  cellspacing='10px'>
												<thead>
												<tr>
													<td style='border-bottom:1px solid #F88C00; font-size:13px;  padding:5px;background:#ffff;text-align:center;'>Wilayah</td>
													<td style='border-bottom:1px solid #F88C00; font-size:13px;  padding:5px;background:#ffff;text-align:center;'>Jenis</td>
													<td style='border-bottom:1px solid #F88C00; font-size:13px;  padding:5px;background:#ffff;text-align:center;'>Volume</td>
													<td style='border-bottom:1px solid #F88C00; font-size:13px;  padding:5px;background:#ffff;text-align:center;'>Sortimen</td>
													<td style='border-bottom:1px solid #F88C00; font-size:13px;  padding:5px;background:#ffff;text-align:center;'>Ukuran</td>
												</tr>
												</thead>
												<tbody>
												<tr>
													<td style='padding:15px; font-size:12px; text-align:center;'>&nbsp;[nama_kantor]</td>
													<td style='padding:15px;font-size:12px;text-align:center;'>&nbsp;[nama_jenis]</td>
													<td style='padding:15px;font-size:12px;text-align:center;'>&nbsp;[volume]</td>
													<td style='padding:15px;font-size:12px;text-align:center;'>&nbsp;[sortimen]</td>
													<td style='padding:15px;font-size:12px;text-align:center;'>&nbsp;[ukuran]</td>
												</tr>
												</tbody>
								...
								<tr>
									<td align='center'><h5>Jangka Waktu Kontrak : <br><i>[start_date] - [end_date]</i></h5></td>
								</tr>
							</table>
						</td>
					</tr>
								...
								<tr>
									<td>
										<table class='full-width' width='387' align='left' border='0' cellpadding='0' cellspacing='0' bgcolor='#ffffff' style='border-radius: 4px;'>
											<tr>
												<td align='center'>
													<table class='table-container' width='350' align='center' border='0' cellpadding='0' cellspacing='0'>
														<tr>
														...
														<tr>
															<td>
																<table width='100%' align='left' border='0' cellpadding='0' cellspacing='0'>
																	<tr>
																		<td data-color='Title A' data-size='Title A' align='left' style='font-family: sans-serif; font-size: 12px;  color: #333333;'>
																			Transfer Uang Jaminan sebesar 90% yang disetujui senilai : 
																		</td>
																	</tr>
																	<tr>
																		<td data-color='Content A' data-size='Content A' align='left' style='font-size: 16px; font-weight:bold; '>
																			<i><u>[total_terbilang] </u>Rupiah</i>
																			
																			<p style='font-size:13px;'>
																			Ke Nomor Rekening: <b>[no_rekening_kbm]<b>
																				 <br>
																			 </p>
																		</td>
																	</tr>
										...
										<table class='full-width' width='1' align='left' border='0' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;'>
											<tr>
												<td width='1' height='40' style='font-size: 10px; line-height: 40px;'>
												</td>
											</tr>
										</table>
										<!-- END SPACE -->
													...
													<table class='table-container' width='250' align='center' border='0' cellpadding='0' cellspacing='0'>
														...
														<tr>
															<td>
																<table width='100%' align='left' border='0' cellpadding='0' cellspacing='0'>
																	<tr>
																		<td data-color='Title A' data-size='Title A' align='left' style='font-family: 'Montserrat', sans-serif; font-size: 10px; font-weight: 400; color: #333333; letter-spacing: 2px; line-height: 48px;'>
		...
		<tr>
			<td bgcolor='#FFFFFF' style='border-bottom: 1px solid #ededed;'>
				<table width='600' border='0' cellspacing='0' cellpadding='0' align='center' class='alignCenter' style='font-family: 'ProximaNW01-AltLightReg', Helvetica, Arial, sans-serif;'>
					...
					<tr>
						<td align='center' class='paddingBoth' style='font-size: 14px;'>
							<i><p style='color: red; padding: 0px 0px 0px 0px;' data-color='Headline Big' data-size='Headline Big' data-min='16'>
					...
					<tr>
						<td>
							<table width='300' border='0' cellspacing='0' cellpadding='0' align='left' class='textAlignCenter' style='font-size: 12px; font-family: 'ProximaNW01-AltLightReg', Helvetica, Arial, sans-serif;'>
								<tr>
									<td data-color='Footer Paragraphs' data-size='Footer Paragraphs' style='font-size:13px;'>
							...
							<table width='300' border='0' cellspacing='0' cellpadding='0' align='right' class='alignCenter' style='font-size: 12px; font-family: 'ProximaNW01-AltLightReg', Helvetica, Arial, sans-serif;'>
								<tr>
									<td align='right' class='increasePadding-BothReset' data-size='Footer Links' data-color='Footer Links' style='font-size:14px; font-weight:bold;'>
