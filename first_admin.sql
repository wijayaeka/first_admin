/*
 ...
 Source Schema         : first_admin

 Target Server Type    : MySQL
 Target Server Version : 100125
 File Encoding         : 65001

 Date: 07/11/2017 23:37:58
*/
...
CREATE TABLE `access_menu`  (
  ...
  `active` varchar(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_access`) USING BTREE,
  INDEX `id_user`(`id_privilege`, `id_menu`) USING BTREE,
  INDEX `id_menu`(`id_menu`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 184 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `access_modul`  (
  ...
  `active` varchar(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_access`) USING BTREE,
  INDEX `id_user`(`id_privilege_modul`, `id_modul`) USING BTREE,
  INDEX `id_menu`(`id_modul`) USING BTREE
...
CREATE TABLE `access_page`  (
  ...
  `active` varchar(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_access`) USING BTREE,
  INDEX `id_user`(`id_privilege_page`, `id_page`) USING BTREE,
  INDEX `id_menu`(`id_page`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 20 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Fixed;
...
INSERT INTO `access_page` VALUES (3, 37, 54, 'N');
INSERT INTO `access_page` VALUES (4, 6, 53, 'N');
...
INSERT INTO `access_page` VALUES (16, 35, 72, 'Y');
INSERT INTO `access_page` VALUES (17, 6, 72, 'Y');
INSERT INTO `access_page` VALUES (18, 6, 73, 'Y');
INSERT INTO `access_page` VALUES (19, 35, 73, 'Y');
...
CREATE TABLE `access_subpage`  (
  ...
  `active` varchar(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_access`) USING BTREE,
  INDEX `id_user`(`id_privilege_subpage`, `id_subpage`) USING BTREE,
  INDEX `id_menu`(`id_subpage`) USING BTREE
...
INSERT INTO `access_subpage` VALUES (3, 37, 59, 'N');
...
INSERT INTO `access_subpage` VALUES (17, 37, 75, 'N');
INSERT INTO `access_subpage` VALUES (18, 6, 76, 'Y');
INSERT INTO `access_subpage` VALUES (19, 35, 76, 'Y');
INSERT INTO `access_subpage` VALUES (20, 37, 76, 'N');
INSERT INTO `access_subpage` VALUES (21, 35, 77, 'Y');
INSERT INTO `access_subpage` VALUES (22, 35, 78, 'Y');
INSERT INTO `access_subpage` VALUES (23, 6, 77, 'Y');
INSERT INTO `access_subpage` VALUES (24, 6, 78, 'Y');
INSERT INTO `access_subpage` VALUES (25, 35, 79, 'Y');
...
CREATE TABLE `adm_jabatan`  (
  ...
  `jbt_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `jbt_nama` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `jbt_penilaian` enum('PENILAIAN','TIDAK') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'PENILAIAN',
  `jbt_status` enum('A','T') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'A',
  `jbt_upd` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `jbt_lup` datetime(0) DEFAULT NULL,
  PRIMARY KEY (`idx`) USING BTREE,
  INDEX `idx_jbt`(`jbt_id`) USING BTREE,
  INDEX `idx_`(`jbt_penilaian`) USING BTREE,
  INDEX `idx_jbtstatus`(`jbt_status`) USING BTREE
...
CREATE TABLE `adm_kategori_page`  (
  ...
  `jenis_page` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `inisial` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_kategori_page`) USING BTREE
...
CREATE TABLE `adm_login`  (
  ...
  `userid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `password` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `img` blob,
  `userlevel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `status` double DEFAULT NULL,
  `nama_lengkap` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  ...
  `lup` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
...
INSERT INTO `adm_login` VALUES (2, 'administrator', '200ceb26807d6bf99fd6f4f0d1ca54d4', 'administrator', 'administrator@gmail.com', 0x6179752D32393830302E6A7067, '6', 0, 'Administrator', 'Fatmawati', '088782329', '2017-11-06 11:43:04');
...
CREATE TABLE `adm_modul`  (
  ...
  `module_name` varchar(130) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `icon_module` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `status_module` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `urutan_module` int(20) DEFAULT NULL,
  `lup` timestamp(0) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `adm_page`  (
  ...
  `nama_page` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `link` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `urutan` int(11) NOT NULL,
  `status_page` enum('Y','N') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'Y',
...
INSERT INTO `adm_page` VALUES (72, 1, 7, 'Client', '', 5, 'Y', 'accessibility e84e');
INSERT INTO `adm_page` VALUES (73, 1, 7, 'Socmed Wifi', '', 6, 'Y', 'laptop_chromebook e31f');
...
CREATE TABLE `adm_privilage_page`  (
  ...
  `id_page` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `id_level` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `aktif` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_privilage_page`) USING BTREE
...
CREATE TABLE `adm_privilage_subpage`  (
  ...
  `id_subpage` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `id_level` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `aktif` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_privilage_subpage`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `adm_sub_page`  (
  ...
  `nama_subpage` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `link_subpage` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `urutan_subpage` int(11) NOT NULL,
  `status_subpage` enum('Y','N') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'Y',
  `subpage_icon` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_subpage`) USING BTREE
...
INSERT INTO `adm_sub_page` VALUES (59, 54, 'Front Menu', 'pagetree_menu', 2, 'Y', 'first_page e5dc');
...
INSERT INTO `adm_sub_page` VALUES (77, 72, 'List Client', 'list_client', 1, 'Y', 'work e8f9');
INSERT INTO `adm_sub_page` VALUES (78, 72, 'User Client', 'client_user_client', 2, 'Y', 'filter_7 e3d7');
INSERT INTO `adm_sub_page` VALUES (79, 73, 'Accounts', 'socmed_account', 1, 'Y', 'lens e3fa');
...
CREATE TABLE `article`  (
  ...
  `url_article` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `headline` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'N',
  `running_news` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'N',
  `isi_article` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `isi_article_eng` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `video` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `poster_video` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `embbed_video` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `video_active` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'D',
  `gen_code_article` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `gen_code_photo` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `gen_code_video` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `status` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'Y',
  `dibaca` int(5) NOT NULL,
  `id_menu` int(100) NOT NULL,
  `id_sidemenu` int(11) NOT NULL,
  `menu_stats` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `sidemenu_stats` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `document` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `komentar_status` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'N',
...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES (1, '1', 'Lorem ipsum 2', 1, '1', 'lorem-ipsum-2', 'on', 'on', '&lt;html&gt;&lt;head&gt; &lt;title&gt;&lt;/title&gt;&lt;/head&gt;&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.&lt;/body&gt;&lt;/html&gt;', '&lt;html&gt;&lt;head&gt; &lt;title&gt;&lt;/title&gt;&lt;/head&gt;&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.&lt;/body&gt;&lt;/html&gt;     ', 'Kamis', '2017-09-26', '04:59:15', '6BE3D1E5.PNG', '', '', '', 'D', '', '', '', 'on', 0, 0, 0, '', '', '', 'on');
INSERT INTO `article` VALUES (2, '1', 'OKE', 2, '2', 'oke', 'on', 'on', '&lt;html&gt;\r\n&lt;head&gt;\r\n &lt;title&gt;&lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.&lt;/body&gt;\r\n&lt;/html&gt;\r\n', '&lt;html&gt;\r\n&lt;head&gt;\r\n &lt;title&gt;&lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.&lt;/body&gt;\r\n&lt;/html&gt;\r\n', 'Kamis', '2017-11-02', '03:58:59', 'ED65BABA.PNG', '', '', '', 'D', '', '', '', 'on', 0, 0, 0, '', '', '', 'on');
INSERT INTO `article` VALUES (3, '1', 'OKE', 2, '2', 'oke', 'on', 'on', '&lt;html&gt;&lt;head&gt; &lt;title&gt;&lt;/title&gt;&lt;/head&gt;&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.&lt;/body&gt;&lt;/html&gt;', '&lt;html&gt;&lt;head&gt; &lt;title&gt;&lt;/title&gt;&lt;/head&gt;&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.&lt;/body&gt;&lt;/html&gt;', 'Kamis', '2017-09-25', '08:49:47', 'F78A1226', '', '', '', 'D', '', '', '', 'on', 0, 0, 0, '', '', '', 'on');
INSERT INTO `article` VALUES (4, '1', 'Arsenal Sudah Main Lebih Baik saat Lawan WBA', 4, '1', 'arsenal-sudah-main-lebih-baik-saat-lawan-wba', 'on', 'on', '&lt;html&gt;\r\n&lt;head&gt;\r\n &lt;title&gt;&lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;X<img alt=\"\" src=\"https://akcdn.detik.net.id/community/media/visual/2017/09/26/c25679d6-46a5-44ee-990c-af4f3d14633d_43.jpg?w=780&q=90\" xss=removed> <strong>London</strong> - BArsenal disebut sudah tampil lebih oke di laga melawan West Bromwich Albion. Manajer The Gunners, Arsene Wenger, juga dinilai mempunyai nilai lebih di laga itu.<br>\r\n<br>\r\nSaat menjalani pertandingan melawan WBA di Emirates Stadium, Selasa (26/9/2017) dinihari WIB, Arsenal memetik kemenangan dengan skor akhir dua gol tanpa balas.<br>\r\n \r\n<table class=\"linksisip\">\r\n <tbody>\r\n  <tr>\r\n   <td>\r\n   <div class=\"lihatjg\"><strong>Baca juga: </strong><a href=\"https://sport.detik.com/sepakbola/read/2017/09/26/042705/3657960/72/dua-gol-lacazette-menangkan-arsenal\" target=\"_blank\">Dua Gol Lacazette Menangkan Arsenal</a></div>\r\n   </td>\r\n  </tr>\r\n </tbody>\r\n</table>\r\n<br>\r\nAlexandre Lacazette menjadi pencetak dua gol Arsenal itu. Yang pertama dibukukan pada menit ke-20. Satu lainnya dicetak lewat titik putih.\r\n<div id=\"beacon_05d40e29b6\"><img alt=\"\" src=\"https://newrevive.detik.com/delivery/lg.php?bannerid=0&campaignid=0&zoneid=723&loc=https://sport.detik.com/sepakbola/liga-inggris/d-3657965/arsenal-sudah-main-lebih-baik-saat-lawan-wba?_ga=2.256482635.1515193677.1506393691-1429954452.1506393691&referer=https://news.detik.com/bbc-world/d-3658135/selundupkan-1-kg-emas-di-duburnya-pria-sri-lanka-ditangkap?_ga=2.257554763.1515193677.1506393691-1429954452.1506393691&cb=05d40e29b6\"></div>\r\n<br>\r\nBagi Arsenal, laga melawan WBA ini menjadi ketiga kalinya secara berurutan membukukan <em>clean sheet</em>. Kemenangan ini mendapatkan pujian dari eks pemain The Gunners, Martin Keown.<br>\r\n<br>\r\n\"Ada sedikit kerja sama yang dibangun di dalam tim,\" kata Keown di <em>BBC</em>.<br>\r\n<br>\r\n\"Sead Kolasinac terlihat sangat kuat di tim ini. Ramsey bermain dengan kepercayaan diri, Lacazette terlihat sangat mengancam dan Sanchez kembali ke tim serta terlihat senang. Itu menjadi nilai tambah untuk Wenger,\" kata dia lagi.&lt;/body&gt;\r\n&lt;/html&gt;\r\n', '&lt;html&gt;\r\n&lt;head&gt;\r\n &lt;title&gt;&lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;<img alt=\"\" src=\"https://akcdn.detik.net.id/community/media/visual/2017/09/26/c25679d6-46a5-44ee-990c-af4f3d14633d_43.jpg?w=780&q=90\"> <strong>London</strong> - Arsenal disebut sudah tampil lebih oke di laga melawan West Bromwich Albion. Manajer The Gunners, Arsene Wenger, juga dinilai mempunyai nilai lebih di laga itu.<br>\r\n<br>\r\nSaat menjalani pertandingan melawan WBA di Emirates Stadium, Selasa (26/9/2017) dinihari WIB, Arsenal memetik kemenangan dengan skor akhir dua gol tanpa balas.<br>\r\n \r\n<table class=\"linksisip\">\r\n <tbody>\r\n  <tr>\r\n   <td>\r\n   <div class=\"lihatjg\"><strong>Baca juga: </strong><a href=\"https://sport.detik.com/sepakbola/read/2017/09/26/042705/3657960/72/dua-gol-lacazette-menangkan-arsenal\" target=\"_blank\">Dua Gol Lacazette Menangkan Arsenal</a></div>\r\n   </td>\r\n  </tr>\r\n </tbody>\r\n</table>\r\n<br>\r\nAlexandre Lacazette menjadi pencetak dua gol Arsenal itu. Yang pertama dibukukan pada menit ke-20. Satu lainnya dicetak lewat titik putih.\r\n<div id=\"beacon_05d40e29b6\"><img alt=\"\" src=\"https://newrevive.detik.com/delivery/lg.php?bannerid=0&campaignid=0&zoneid=723&loc=https://sport.detik.com/sepakbola/liga-inggris/d-3657965/arsenal-sudah-main-lebih-baik-saat-lawan-wba?_ga=2.256482635.1515193677.1506393691-1429954452.1506393691&referer=https://news.detik.com/bbc-world/d-3658135/selundupkan-1-kg-emas-di-duburnya-pria-sri-lanka-ditangkap?_ga=2.257554763.1515193677.1506393691-1429954452.1506393691&cb=05d40e29b6\"></div>\r\n<br>\r\nBagi Arsenal, laga melawan WBA ini menjadi ketiga kalinya secara berurutan membukukan <em>clean sheet</em>. Kemenangan ini mendapatkan pujian dari eks pemain The Gunners, Martin Keown.<br>\r\n<br>\r\n\"Ada sedikit kerja sama yang dibangun di dalam tim,\" kata Keown di <em>BBC</em>.<br>\r\n<br>\r\n\"Sead Kolasinac terlihat sangat kuat di tim ini. Ramsey bermain dengan kepercayaan diri, Lacazette terlihat sangat mengancam dan Sanchez kembali ke tim serta terlihat senang. Itu menjadi nilai tambah untuk Wenger,\" kata dia lagi.&lt;/body&gt;\r\n&lt;/html&gt;\r\n', 'Kamis', '2017-09-26', '05:07:05', 'B805D222.PNG', '', '', '', 'D', '', '', '', 'on', 0, 0, 0, '', '', '', 'on');
INSERT INTO `article` VALUES (5, '1', 'Test 2', 4, '1', 'test-2', 'on', '', '&lt;html&gt;\r\n&lt;head&gt;\r\n &lt;title&gt;&lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.ss ABCDEFGHIJKLMOPQ&lt;/body&gt;\r\n&lt;/html&gt;\r\n', '&lt;html&gt;\r\n&lt;head&gt;\r\n &lt;title&gt;&lt;/title&gt;\r\n&lt;/head&gt;\r\n&lt;body&gt;Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.ssssss ABCDEFGHIJKLMOPQ&lt;/body&gt;\r\n&lt;/html&gt;\r\n', 'Kamis', '2017-10-10', '05:18:14', '29AA04C8.PNG', '', '', '', 'D', '', '', '', 'on', 0, 0, 0, '', '', '', '');
...
CREATE TABLE `article_category`  (
  ...
  `article_category_name` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `status` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_category_article`) USING BTREE
...
-- ----------------------------
-- Table structure for assisgn_menu_article2
-- ----------------------------
DROP TABLE IF EXISTS `assisgn_menu_article2`;
CREATE TABLE `assisgn_menu_article2`  (
  `id_assign` int(255) NOT NULL AUTO_INCREMENT,
  `id_menu` int(255) DEFAULT NULL,
  `id_article` int(255) DEFAULT NULL,
  `status` enum('Y','N') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_assign`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of assisgn_menu_article2
-- ----------------------------
INSERT INTO `assisgn_menu_article2` VALUES (1, 102, 5, 'N');
INSERT INTO `assisgn_menu_article2` VALUES (2, 145, 4, 'Y');
INSERT INTO `assisgn_menu_article2` VALUES (3, 145, 1, 'N');
...
CREATE TABLE `client`  (
  ...
  `official_email` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `alamat` longtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `no_telp` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `logo_client` longblob,
  `status_client` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `description` longtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE,
  FULLTEXT INDEX `nama_client`(`client_name`, `official_email`, `status_client`)
) ENGINE = MyISAM AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of client
-- ----------------------------
INSERT INTO `client` VALUES (9, 'Iwifi Demo', 'emailfatma@gmail.com', '      Fatmawati     ', '0212342334539458', 0x39414643433831372E706E67, 'Y', '       Description     ');
INSERT INTO `client` VALUES (13, 'Unify', 'email@email.com', '  Address', '0212342334539458', 0x46323732313345422E706E67, 'Y', '  Description');
INSERT INTO `client` VALUES (14, 'Indihome', 'indihome@gmail.com', 'Indihome Address', '0843459', 0x37383733454244362E6A7067, 'Y', '  description');

-- ----------------------------
-- Table structure for client_venue
-- ----------------------------
DROP TABLE IF EXISTS `client_venue`;
CREATE TABLE `client_venue`  (
  `id` int(100) NOT NULL AUTO_INCREMENT,
  `venue_id` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `parent_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `nama_venue` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  ...
  `directory` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `address` longtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `description` longtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `type_landing_page` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `venue_id`(`venue_id`, `parent_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 196 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of client_venue
-- ----------------------------
INSERT INTO `client_venue` VALUES (1, 'mt-ameera-bandung', '1', 'Ameera Bandung', '98723423459238457', '982334377344', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (12, 'mt-ameeera-bali', '1', 'Ameera Bali', '99232348', '0233458', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (11, 'mt-ameera-jaksel', '1', 'Ameera Jakarta Selatan', '992342348', '92342349', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (9, '2JKT000161/2JKT-JTN0117-0187AI:test-socmed@wifi.id', '2', 'Starbuck Kuningan', '9923324398', '298234248', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (10, '88234238348', '2', 'Starbuck Lebak Bulus', '882342348', '9234345', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (13, 'mt-ameera-surabaya', '1', 'Ameera Surabaya', '02342348', '92382348', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (14, 'nexa_hotel', '3', 'Nexa Hotel Bandung', '82342349', '29834234', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (15, 'test', '3', 'Nexa Test', '0234', '0485', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (16, '2JKT000095/2JKT-JTN0104-12BI:test-socmed@wifi.id', '4', 'Wifiid Infomedia Nusantara Fatmawati', '', '', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (17, 'iwifi-demo', '6', 'Infomedia wifi demo 1', '', '', 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (18, 'grandsahidjaya@wifi.id', '8', 'Sahid Sudirman', '106.820224', '-6.211048', 'Y', 'sahid', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (20, 'JKTSLP00217/TLK-WI529743-0001:Jco_TamanAnggrek', '7', 'Jco Mall Taman Anggrek', '106.792666', '-6.178315', 'Y', 'jco_mall_taman_anggrek', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (21, 'test-socmed@wifi.id', '9', 'Infomedia Fatmawati', '106.79694772', '-6.26136926', 'Y', 'starbuck', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (22, 'testsocmed@wifi.id', '9', 'STO Gambir', '106.82623342', '-6.18104356', 'Y', 'starbuck', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (23, 'nexa_hotel', '9', 'Nexa Hotel Bandung', '107.6294486', '-6.9053963', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (24, 'JKTPSR00240/TLK-WI404168-0001:Jco_GreenTerrace', '7', 'Jco Green Terrace', '', '', 'Y', 'jco_green_terrace', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (25, 'Coffebean@wifi.id', '12', 'Coffebean', '', '', 'Y', 'transcafe', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (26, 'JKTKT200118/TLK-WI607293-0001:Jco_STKota', '7', 'Jco Stasiun Kota', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (27, 'JKTKLG00140/TLK-WI602310-0001:Jco_MKG2', '7', 'Jco MKG2', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (28, 'DPRNSD00076/TLK-WI389122-0003:agendazbali', '13', 'Ap 3', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (29, 'DPRNSD00076/TLK-WI389122-0004:agendazbal', '13', 'Ap 4', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (30, 'DPRNSD00076/TLK-WI389122-0002:agendazbal', '13', 'Ap 2', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (31, 'JKTSMI00158/03-07AI-At-DPKMR362:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (32, 'JKTSMI00158/09-11AI-At-DPKMR901:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (33, 'JKTSM100011/TLK-WI511273-0002:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (34, 'JKTSMI00158/03-26AI-At-DPKMR356:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (35, 'JKTSMI00158/03-05AI-At-DPKMR349:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (36, 'JKTSMI00158/03-06AI-At-DPKMR358:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (37, 'JKTSMI00158/03-22AI-At-DPKMR390:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (38, 'JKTSMI00158/04-01AI-At-DPKMR472:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (39, 'JKTSMI00158/04-07AI-At-DPKMR419:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (40, 'JKTSMI00158/03-01AI-At-DPKMR334:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (41, 'JKTSMI00158/09-12AI-At-DPKMR970:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (42, 'JKTSMI00158/05-02AI-At-DPKMR537:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (43, 'JKTSMI00158/05-07AI-At-DPKMR562:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (44, 'JKTSMI00158/04-13AI-At-DPKMR438:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (45, 'JKTSMI00158/03-13AI-At-DPKMR319:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (46, 'JKTSMI00158/05-20AI-At-DPKMR511:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (47, 'JKTSMI00158/05-01AI-At-DPKMR533:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (48, 'JKTSMI00158/03-23AI-At-DPKMR370:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (49, 'JKTSMI00158/05-05AI-At-DPKMR547:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (50, 'JKTSMI00158/04-14AI-At-DPKMR440:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (51, 'JKTSMI00158/05-06AI-At-DPKMR556:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (52, 'JKTSMI00158/03-16AI-At-DPKMR305:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (53, 'JKTSMI00158/03-10AI-At-DPKMR353:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (54, 'JKTSMI00158/04-12AI-At-DPKMR432:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (55, 'JKTSMI00158/05-25AI-At-DPKMR567:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (56, 'JKTSMI00158/04-10AI-At-DPKMR405:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (57, 'JKTSMI00158/05-03AI-At-DPKMR540:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (58, 'JKTSMI00158/03-21AI-At-DPKMR386:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (59, 'JKTSMI00158/05-24AI-At-DPKMR530:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (60, 'JKTSMI00158/05-16AI-At-DPKMR572:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (61, 'JKTSMI00158/05-22AI-At-DPKMR501:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (62, 'JKTSMI00158/04-03AI-At-DPKMR482:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (63, 'JKTSMI00158/09-02AI-At-DPKMR978:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (64, 'JKTSMI00158/05-04AI-At-DPKMR544:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (65, 'JKTSMI00158/05-13AI-At-DPKMR584:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (66, 'JKTSM100011/TLK-WI511273-0001:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (67, 'JKTSMI00158/05-11AI-At-DPKMR557:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (68, 'JKTSMI00158/03-12AI-At-DPKMR325:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (69, 'JKTSMI00158/04-05AI-At-DPKMR490:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (70, 'JKTSMI00158/03-18AI-At-DPKMR374:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (71, 'JKTSMI00158/09-09AI-At-DPKMR909:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (72, 'JKTSMI00158/05-21AI-At-DPKMR505:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (73, 'JKTSMI00158/04-18AI-At-DPKMR460:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (74, 'JKTSMI00158/03-14AI-At-DPKMR315:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (75, 'JKTSMI00158/03-24AI-At-DPKMR330:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (76, 'JKTSMI00158/09-06AI-At-DPKMR925:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (77, 'JKTSMI00158/04-04AI-At-DPKMR486:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (78, 'JKTSMI00158/04-11AI-At-DPKMR401:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (79, 'JKTSMI00158/05-10AI-At-DPKMR553:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (80, 'JKTSMI00158/05-17AI-At-DPKMR525:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (81, 'JKTSMI00158/04-23AI-At-DPKMR470:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (82, 'JKTSMI00158/03-25AI-At-DPKMR367:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (83, 'JKTSMI00158/03-19AI-At-DPKMR378:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (84, 'JKTSMI00158/05-15AI-At-DPKMR576:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (85, 'JKTSMI00158/05-23AI-At-DPKMR570:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (86, 'JKTSMI00158/03-02AI-At-DPKMR338:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (87, 'JKTSMI00158/09-01AI-At-DPKMR972:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (88, 'JKTSMI00158/09-07AI-At-DPKMR921:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (89, 'JKTSMI00158/03-11AI-At-DPKMR357:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (90, 'JKTSMI00158/04-26AI-At-DPKMR456:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (91, 'JKTSMI00158/05-09AI-At-DPKMR549:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (92, 'JKTSMI00158/05-19AI-At-DPKMR515:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (93, 'JKTSMI00158/09-08AI-At-DPKMR915:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (94, 'JKTSMI00158/03-08AI-At-DPKMR336:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (95, 'JKTSMI00158/04-17AI-At-DPKMR466:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (96, 'JKTSMI00158/04-09AI-At-DPKMR409:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (97, 'JKTSMI00158/04-25AI-At-DPKMR467:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (98, 'JKTSMI00158/03-09AI-At-DPKMR348:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (99, 'JKTSMI00158/04-24AI-At-DPKMR430:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (100, 'JKTSMI00158/05-14AI-At-DPKMR580:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (101, 'JKTSMI00158/09-04AI-At-DPKMR986:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (102, 'JKTSMI00158/05-18AI-At-DPKMR519:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (103, 'JKTSM100011/TLK-WI511273-0003:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (104, 'JKTSMI00158/04-22AI-At-DPKMR452:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (105, 'JKTSMI00158/05-12AI-At-DPKMR588:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (106, 'JKTSMI00158/03-20AI-At-DPKMR382:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (107, 'JKTSMI00158/03-17AI-At-DPKMR301:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (108, 'JKTSMI00158/05-26AI-At-DPKMR556:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (109, 'JKTSMI00206/TLK-WI510778-0001:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (110, 'JKTSMI00158/04-15AI-At-DPKMR445:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (111, 'JKTSMI00158/03-04AI-At-DPKMR346:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (112, 'JKTSMI00158/03-15AI-At-DPKMR309:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (113, 'JKTSMI00158/04-02AI-At-DPKMR476:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (114, 'JKTSMI00158/09-05AI-At-DPKMR990:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (115, 'JKTSMI00158/04-06AI-At-DPKMR425:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (116, 'JKTSMI00158/04-20AI-At-DPKMR449:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (117, 'JKTSMI00158/03-03AI-At-DPKMR342:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (118, 'JKTSMI00158/AP_TES_TREG2_PART:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (119, 'JKTSMI00158/04-21AI-At-DPKMR450:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (120, 'JKTSMI00158/AP_TEST_NOC_GAMBIR:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (121, 'JKTSMI00158/04-08AI-At-DPKMR415:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (122, 'JKTSMI00206/TLK-WI510778-0003:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (123, 'JKTSMI00195/TLK-WI511348-0001:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (124, 'JKTSMI00158/04-16AI-At-DPKMR447:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (125, 'JKTSMI00158/09-10AI-At-DPKMR905:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (126, 'JKTSMI00158/09-03AI-At-DPKMR982:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (127, 'JKTSMI00158/04-19AI-At-DPKMR458:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (128, 'JKTSMI00195/TLK-WI511348-0003:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (129, 'JKTSMI00195/TLK-WI511348-0004:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (130, 'JKTSMI00206/TLK-WI510778-0002:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (131, 'JKTSMI00195/TLK-WI511348-0002:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (132, 'JKTSMI00158/05-08AI-At-DPKMR558:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (133, 'JKTSM100011/TLK-WI511273-0004:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (134, 'JKTSMI00206/TLK-WI510778-0004:grandsahidjaya@wifi.id', '8', 'Hotel Sahid Sudirman', '0', '0', 'Y', '-', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (135, 'JKTSLP00223/TLK-WI605827-0001:Coffeebean@wifi.id', '12', 'Coffeebean Taman Anggrek', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (136, 'JKTSMI00214/TLK-WI612595-0001:Coffeebean@wifi.id\r\n', '12', 'Coffee Bean FX Plaza', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (137, 'JKTCPE00185/TLK-WI612731-0001:CoffeeBean@wifi.id\r\n', '12', 'JKTCPE00185/TLK-WI612731-0001', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (138, 'JKTKLG00163/TLK-WI608078-0001:Coffeebean@wifi.id\r\n', '12', 'Mall Kelapa Gading', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (139, 'BPPBRU00100/TLK-WI527553-0001:Coffeebean@wifi.id\r\n', '12', 'Coffee Bean Transmart Daun Village', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (140, 'BJMULI00205/TLK-WI642752-0001:Coffeebean@wifi.id\r\n', '12', 'CoffeeBean Duta Mall BJM', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (141, 'JKTSTR00136/TLK-WI643915-0001:A2000@wifi.id', '14', 'Astra Auto 2000', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (142, 'MDNSKI00060/AP_NOC_JKT_BARU:A2000@wifi.id', '14', 'Auto 2000', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (143, 'JKTCBB00039/TLK-WI527102-0001:Jco_KM10', '7', 'JCO KM10', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (144, 'DPRKLM00320/TLK-WI396477-0001:jco_teukuumar', '7', 'JCO Teuku Umar', NULL, NULL, 'Y\r\n', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (145, 'MDNMDC00373/TLK-WI404013-0001:Jco_SunPlaza', '7', 'JCO Sunplaza Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (146, 'MDNMDC00374/TLK-WI404243-0001:Jco_CambridgeMedan', '7', 'JCO Cambridge Mall Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (147, 'SLOSLO00022/TLK-WI386850-0001:JCOTheParkSolo', '7', 'JCO Teh Park Solo', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (148, 'JKTSM100067/TLK-WI616578-0001:Jco_Semanggi2', '7', 'JCO Semanggi 2', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (149, 'SMJHR00126/TLK-WI498236-0001:Jco_ParagonSemarang', '7', 'JCO Paragon Semarang', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (150, 'SMJHR00126/TLK-WI404232-0001:Jco_ParagonSemarang', '7', 'JCO Paragon Semarang 2', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (151, 'BDLKDT00231/TLK-WI404301-0001:Jco_BKL', '7', 'JCO BKL', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (152, 'MTRMTR00205/TLK-WI402061-0001:Jco_LEL', '7', 'JCO LEL', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (153, 'YKKBU00483/01-01AI-Rg_Saji:JCOHMJ@wifi.id', '7', 'JCO HMJ', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (154, 'YKBBS00096/01-01BI-Rg_Saji:JCO_AmbarukmoPlaza@wifi.id', '7', 'JCO Ambarukmo Plaza', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (155, 'JKTKLG00140/TLK-WI602310-0001:Jco_MKG2', '7', 'JCO Kelapa Gading', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (156, 'BTMBTC00194/TLK-WI404011-0001:Jco_MMBC@wifi.id', '7', 'JCO Mega Mall Batam Center', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (157, 'BDHGM00003/TLK-WI404012-0001:Jco_PVJ', '7', 'JCO Paris van Java', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (158, 'CBNCBN00091/TLK-WI473930-0001:Jco_CSB', '7', 'JCO Cirebon Super Block', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (159, 'KWKTLJ00028/TLK-WI524560-0001:Jco_Km39', '7', 'JCO KM 39', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (160, 'PWKPWK00049/TLK-WI477458-0001:Jco_KM', '7', 'JCO KM 72', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (161, 'JKTSM100032/TLK-WI616227-0001:Jco_Semanggi2', '7', 'JCO Plaza Semanggi', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (162, '2JKT-CKA-0701:Jco_AHB', '7', 'JCO Airport hub shopping mall', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (163, 'SDASDA00253/TLK-WI729225-0001:JCO_CPS', '7', 'JCO Sun City Sidoarjo', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (164, '1MDN000855/TLK-WI562383-0013:Santika Wifi', '15', 'Santika Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (165, '1MDN000855/TLK-WI563248-0017:Santika Wifi', '15', 'Santika Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (166, '1MDN000855/TLK-WI562383-0009:Santika Wifi', '15', 'Santika Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (167, '1MDN000855/TLK-WI562383-0012:Santika Wifi', '15', 'Santika Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (168, 'JKTSLP00217/TLK-WI529743-0001:Coffeebean@wifi.id', '12', 'TransCafe EWalk Balikpapan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (169, 'BDRJW00023/TLK-WI543329-0001:Coffeebean@wifi.id', '12', 'Transmart Cimahi', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (170, 'DPRKUT00173/TLK-WI525091-0001:Coffeebean@wifi.id', '12', 'Galeria Mall Bali', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (171, 'MDNMDC00401/TLK-WI684218-0001:Coffeebean@wifi.id', '12', 'Center Point Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (172, 'SLOSLO00048/TLK-WI720233-0001:Coffeebean@wifi.id', '12', 'Coffee Bean Carrefour Solo', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (173, 'YKBBS00155/TLK-WI713292-0001:Coffeebean@wifi.id', '12', 'AdiSucipto Airport', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (174, 'SLOKRS00020/TLK-WI740233-0001:Coffeebean@wifi.id', '12', 'The Park Solo', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (175, 'MDNMD200022/TLK-WI757959-0001:Coffeebean@wifi.id', '12', 'Coffee Bean Chrystal Medan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (176, 'BPPKTB00028/TLK-WI688653-0001:Coffeebean@wifi.id', '12', 'Coffee Bean E - WALK Balikpapan', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (177, 'SMRSMR00218/TLK-WI713289-0001:Coffeebean@wifi.id', '12', 'Coffee Bean Plaza Mulia Samarinda', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (178, 'SBDMO00103/TLK-WI732939-0001:Coffeebean@wifi.id', '12', 'Ciputra World Square', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (179, 'JKTCKG00351/TLK-WI715865-0001:Jco_tamanpalem', '7', 'JCO Taman Palem ', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (180, 'SLOKRT00303/TLK-WI723547-0001:Jco_grandmallsolo', '7', 'JCO Solo Grand Mal', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (181, 'JKTKLG00223/TLK-WI755705-0001:Jco_ArthaGading', '7', 'JCO Mall Artha Gading', NULL, NULL, 'Y', NULL, NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (182, 'UNRUNR00051/TLK-WI504495-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 1', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (183, 'TBKTBK00039/TLK-WI476214-0002:KFC_FreeWifi', '16', 'KFC_FreeWifi 2', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (184, 'TBKTBK00039/TLK-WI476214-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 3', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (185, 'PREPIN00035/TLK-WI508286-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 4', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (186, 'PBRARK00177/TLK-WI516869-0002:KFC_FreeWifi', '16', 'KFC_FreeWifi 5', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (187, 'PBRARK00177/TLK-WI516869-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 6', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (188, 'JKTKT100050/TLK-WI533100-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 7', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (189, 'JKTGBR00351/TLK-WI532691-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 8', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (190, 'JKTCPP00488/TLK-WI476251-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 9', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (191, 'CJSDL00005/TLK-WI584203-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 10', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (192, 'BTMBDS00024/TLK-WI504545-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 11', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (193, 'BTMBDS00024/AP_TEST_NOC_LT3:KFC_FreeWifi', '16', 'KFC_FreeWifi 12', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (194, 'BDCJA00225/TLK-WI646516-0001:KFC_FreeWifi', '16', 'KFC_FreeWifi 13', '', '', 'Y', '', NULL, NULL, NULL);
INSERT INTO `client_venue` VALUES (195, '2BOO016010/2BOO-JTN0127-0185AI:KFC_FreeWifi', '16', 'KFC_FreeWifi 14', '', '', 'Y', '', NULL, NULL, NULL);
...
CREATE TABLE `company`  (
  ...
  `name` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '' COMMENT 'Nama',
  `logo` varchar(54) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `address` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '' COMMENT 'Alamat',
  ...
  `postal_code` varchar(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '',
  `tos` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `about_us` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `registration_email` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `forget_password_email` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `order_email` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `is_deleted` int(1) NOT NULL DEFAULT 0,
  `upd` int(10) DEFAULT NULL,
  `lup` datetime(0) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `content_category`  (
  ...
  `category_name` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
...
CREATE TABLE `front_menu`  (
  ...
  `menu_name` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `menu_name_english` varchar(300) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `link` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `id_parent` int(200) NOT NULL,
  `menu_stats` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `menu_status` enum('Y','N') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'Y',
...
-- ----------------------------
INSERT INTO `front_menu` VALUES (102, 'Corporate Values', 'Corporate Values', 'corporate-values', 92, 'sm1', 5, 92, 0, 0, 0, 0, 'Y', 'tags');
INSERT INTO `front_menu` VALUES (118, 'Gallery', 'Gallery', 'gallery', 92, 'sm1', 5, 92, 0, 0, 0, 0, 'Y', 'star');
INSERT INTO `front_menu` VALUES (119, 'Maxley Tour And Travel', 'Maxley Tour And Travel', 'maxley-tour-and-travel', 93, 'sm1', 3, 93, 0, 0, 0, 0, 'Y', 'plane');
INSERT INTO `front_menu` VALUES (100, 'Board Of Director', 'Board Of Director', 'board-of-director', 92, 'sm1', 3, 92, 0, 0, 0, 0, 'Y', 'tags');
INSERT INTO `front_menu` VALUES (98, 'Overview', 'Overview', 'overview', 92, 'sm1', 1, 92, 0, 0, 0, 0, 'Y', 'tags');
INSERT INTO `front_menu` VALUES (97, 'Kontak', 'Contact', 'contact', 0, 'mm', 6, 0, 0, 0, 0, 0, 'Y', 'envelope');
INSERT INTO `front_menu` VALUES (96, 'Informasi', 'Information', 'information', 0, 'mm', 5, 0, 0, 0, 0, 0, 'Y', 'user');
INSERT INTO `front_menu` VALUES (95, 'Bisnis', 'Business', 'business', 0, 'mm', 4, 0, 0, 0, 0, 0, 'Y', 'suitcase');
INSERT INTO `front_menu` VALUES (94, 'Hotel', 'Hotel', 'hotels', 0, 'mm', 3, 0, 0, 0, 0, 0, 'Y', 'glass');
INSERT INTO `front_menu` VALUES (93, 'Properti', 'Property', 'property', 0, 'mm', 2, 0, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (92, 'Profil Perusahaan', 'Company Profile', 'company-profile', 0, 'mm', 1, 0, 0, 0, 0, 0, 'Y', 'institution');
INSERT INTO `front_menu` VALUES (101, 'Structure Organization', 'Structure Organization', 'structure-organization', 92, 'sm1', 4, 92, 0, 0, 0, 0, 'Y', 'tags');
INSERT INTO `front_menu` VALUES (103, 'Maxley Residentials', 'Maxley Residentials', 'maxley-residentials', 93, 'sm1', 1, 93, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (104, 'Maxley In The Kost', 'Maxley In The Kost', 'maxley-in-the-kost', 93, 'sm1', 2, 93, 0, 0, 0, 0, 'Y', 'lightbulb');
INSERT INTO `front_menu` VALUES (126, 'Price', 'Price', 'price', 104, 'sm2', 4, 93, 104, 0, 0, 0, 'Y', 'star');
INSERT INTO `front_menu` VALUES (123, 'About', 'About', 'about', 104, 'sm2', 1, 93, 104, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (124, 'Room', 'Room', 'room', 104, 'sm2', 2, 93, 104, 0, 0, 0, 'Y', 'suitcase');
INSERT INTO `front_menu` VALUES (125, 'Location', 'Location', 'location', 104, 'sm2', 3, 93, 104, 0, 0, 0, 'Y', 'lightbulb');
INSERT INTO `front_menu` VALUES (136, 'About Us', 'About Us', 'about-us', 94, 'sm1', 1, 94, 0, 0, 0, 0, 'Y', 'tags');
INSERT INTO `front_menu` VALUES (127, 'Gallery', 'Gallery', 'gallery', 104, 'sm2', 5, 93, 104, 0, 0, 0, 'Y', 'plane');
INSERT INTO `front_menu` VALUES (133, 'Karir', 'Career', 'career', 0, 'mm', 8, 0, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (132, 'Sub Kontak', 'sub contact', 'sub-contact', 97, 'sm1', 1, 97, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (134, 'About Travel', 'About Travel', 'about-travel', 119, 'sm2', 1, 93, 119, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (135, 'Gallery', 'gallery', 'gallery', 119, 'sm2', 10, 93, 119, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (137, 'House', 'House', 'house', 94, 'sm1', 2, 94, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (138, 'Town House', 'Town House', 'town-house', 94, 'sm1', 3, 94, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (139, 'Location', 'Location', 'location', 94, 'sm1', 4, 94, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (140, 'Gallery', 'Gallery', 'gallery', 94, 'sm1', 5, 94, 0, 0, 0, 0, 'Y', 'home');
INSERT INTO `front_menu` VALUES (142, 'Alamat', 'Address', 'child3', 132, 'sm2', 2, 97, 132, 0, 0, 0, 'Y', '3d_rotation e84d');
INSERT INTO `front_menu` VALUES (145, 'Indonesian', 'english', 'indonesian', 0, 'mm', 10, 0, 0, 0, 0, 0, 'Y', 'accessibility e84e');
INSERT INTO `front_menu` VALUES (148, 'Sub Career', '  Sub Career', 'sub-career', 145, 'sm1', 1, 0, 0, 0, 0, 0, 'Y', 'access_alarm e190');
...
CREATE TABLE `icon`  (
  ...
  `icon` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 933 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
CREATE TABLE `m_icon`  (
  ...
  `name_icon` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
...
CREATE TABLE `master_account`  (
  ...
  `account_name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `app_key` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `menu`  (
  ...
  `menu_name` varchar(128) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `description` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `icon` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `menu_link` varchar(150) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `menu_sort` int(11) NOT NULL,
  `module_id` int(11) NOT NULL,
  `is_default` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `menu_link_2`(`menu_link`) USING BTREE
