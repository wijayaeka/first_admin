...
<div class="modal-header">
    ...
    <h5 class="modal-title" id="myModalLabel">Add New Page</h5><hr></hr>
</div>
<form class="form-horizontal" id="form_process" method="post" action="<?php echo base_url();?>page/save_new" enctype="multipart/form-data">
<div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                  <div class="input-group ">
                                                      ...
                                                      <div class="form-group is-empty">
                                                          ...
                                                          <select required="true" class="form-control default-select2" name="kategori_page" id="kategori_page" style="width:100%;">
                                                  ...
                                                  <div class="input-group">
                                                      ...
                                                      <div class="form-group is-empty">
                                                          ...
                                                          <?php //echo json_encode($list_level);?>
                                                          <select required="true" class="form-control default-select2" name="modul" id="modul" style="width:100%;">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            ...
                                                            <input required="true" name="page_name" type="text" class="form-control">
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
