                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Socmed Account</h4>
                                    <div class="col-md-12">
...
<script type="text/javascript">
    $('#datatables').DataTable({
                ...
                "ajax": "<?php echo base_url();?>socmed_account/listAccount",
                "columnDefs": [
    ...
    $('#buttonAdd').click( function () {
        $('#noticeModal').modal({backdrop: 'static',keyboard: false});
            $.ajax({
      						type:"POST",
      						url:"<?php echo base_url()?>page/add_new",
      						data:token,
        ...
        $('#buttonEdit').click( function () {
            ...
            $('#noticeModal').modal({backdrop: 'static',keyboard: false});
                $.ajax({
          						type:"POST",
          						url:"<?php echo base_url()?>page/edit_page",
