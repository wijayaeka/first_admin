...
<form class="form-horizontal" id="form_process" method="post" action="<?php echo base_url();?>subpage/save_new" enctype="multipart/form-data">
<div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                  <div class="input-group ">
                                                      ...
                                                      <div class="form-group is-empty">
                                                          ...
                                                          <?php
                                                              foreach($list_page as $lk){

                                                                echo "<option value='".$lk->id_page."' >".$lk->nama_page."</option>";
                                                              }
                                                          ?>
                                                         </select>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            <label class="control-label">Link Subpage
                                                                <small>(required)</small>
                                                            </label>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group is-empty">
                                                            <label class="control-label">Icon Subpage
                                                            </label><br>
                                                            <?php //echo json_encode($list_level);?>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            <label class="control-label">Subpage Order
                                                                <small>(required)</small>
                                                            </label>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group is-empty">
                                                            <label class="control-label">Status Subpage
                                                            </label><br>
