...
$('#datatables2').DataTable({
            ...
            "ajax": "<?php echo base_url();?>privilege/listLevelmodule/?modul_id="+modul_id+"",
            "language": {
                search: "_INPUT_",
            ...
            'columnDefs': [
             ...
             'render': function (data, type, row){
                if(row[3] == 'Y'){
                  return '<input type="checkbox" checked name="id[]" value="' + $('<div/>').text(data).html() + ' ">';
               }else{
