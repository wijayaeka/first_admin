...
<form class="form-horizontal" id="form_process" method="post" action="<?php echo base_url();?>list_client/update_client" enctype="multipart/form-data">
<div class="row">
<div class="modal-body" style="margin-top:-5%;">
	<?php
		foreach($detil_client as $a){
			//echo json_encode($a);
	?>
      <input type="hidden" id="<?php echo $this->security->get_csrf_token_name(); ?>" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
       <input type="hidden"	name="id_client" value="<?php echo $a->id?>">
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            ...
                                                            <input required="true" name="client_name" type="text" value="<?php echo $a->client_name;?>" class="form-control">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                           ...
                                                           <textarea class="form-control" name="address"> <?php echo $a->alamat;?> </textarea>
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            ...
                                                            <input name="email" required="true" type="text"  value="<?php echo $a->official_email;?>"  class="form-control" >
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                           ...
                                                           <textarea class="form-control" name="description"> <?php echo $a->description;?> </textarea>
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group is-empty">
                                                            <label class="control-label">No Telp
                                                             ...
                                                             <input name="no_telp" required="true" type="text"  value="<?php echo $a->no_telp;?>"  class="form-control" >
                                                        <span class="material-input"></span></div>
												...
												<div class="col-sm-6">
                                                    ...
                                                    <div id="image_holder_default" class=" thumbnail" style="border-radius:none;">
                                                   	...
                                                   	//echo $a->logo_client ;
                                                        if($a->logo_client != ""){
                                                            ?>
                                                            <img src="<?php echo base_url()?>assets/article_content/<?php echo $a->logo_client; ?>" class="picture-src" id="wizardPicturePreview" title="">
                                                            <?php
                                                        }else{
                                                            ?>
                                                  ...
                                                  <span class="btn btn-round btn-rose btn-file">
                                                        ...
                                                        <input type="file" class="form-control" name="foto" value="<?php echo $a->logo_client;?>" id="foto" onchange="upload_img(this)" />
                                                      </span>
