...
<div class="modal-header">
    ...
    <h5 class="modal-title" id="myModalLabel">Add New Tenant</h5><hr></hr>
</div>
...
<div class="modal-body" style="margin-top:-5%;">
      <input type="hidden" id="<?php echo $this->security->get_csrf_token_name(); ?>" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            <label class="control-label">Venue Name
                                                                <small>(required)</small>
                                                            </label>
                                                            <input required="true" name="venue_name" type="text" class="form-control">
												...
												<div class="col-sm-6">
                                              			...
                                              			<h4 class="card-title">Social Media Active</h4>
                                              			<hr></hr>
                                                      	<div class="input-group">
		                                                    <span class="input-group-addon">
		                                                    ...
		                                                    <div class="form-group is-empty">
		                                                        <label class="control-label">Google
		                                                        </label><br>
		                                                        <div class="togglebutton">
		                                                        <label>
		                                                            <input type="checkbox"  name="google" id="google"><span class="toggle"></span>
		                                                        </label></div>
		                                                    <span class="material-input"></span></div>
		                                                    ...
		                                                    <div class="form-group is-empty">
		                                                        ...
		                                                        <div class="togglebutton">
		                                                        <label>
		                                                            <input type="checkbox"  name="facebook" id="facebook"><span class="toggle"></span>
		                                                        </label></div>
		                                                    <span class="material-input"></span></div>
		                                                    ...
		                                                    <div class="form-group is-empty">
		                                                        ...
		                                                        <div class="togglebutton">
		                                                        <label>
		                                                            <input type="checkbox"  name="twitter" id="twitter"><span class="toggle"></span>
		                                                        </label></div>
		                                                    <span class="material-input"></span></div>
		                                                </div>
                                                		<div class="input-group ">
													...
													<div class="form-group is-empty">
														 <span class="material-input"></span>
                                                          <label class="control-label">Type Lading Page
                                                          </label><br>
