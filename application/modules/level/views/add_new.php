<div class="modal-header">
    ...
    <h5 class="modal-title" id="myModalLabel">Add New Level</h5><hr></hr>
</div>
<form class="form-horizontal" id="form_process" method="post" action="<?php echo base_url();?>level/save_new" enctype="multipart/form-data">
<div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            ...
                                                            <input name="level_code" type="text" class="form-control">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating is-empty">
                                                            ...
                                                            <input name="level_name" type="text" class="form-control">
                                                        <span class="material-input"></span></div>
                                                    </div>
                                                </div>
